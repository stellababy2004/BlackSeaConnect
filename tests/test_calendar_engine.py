...
class CalendarEngineTests(unittest.TestCase):
    ...
    def test_visibility_filters_widgets_and_property_pages(self):
        ...
        self.assertIn("View full calendar", admin_dashboard_html)
        ...
        self.assertIn("/owners/calendar?property=property-1&amp;lang=en", owner_property_html)
        self.assertIn("/owners/calendar?property=property-1", owner_property_html)
