...
class CalendarEngineTests(unittest.TestCase):
    ...
    def test_visibility_filters_widgets_and_property_pages(self):
        ...
        self.assertIn("View calendar", owner_dashboard_html)
        self.assertIn("Today", owner_dashboard_html)
        self.assertIn("Tomorrow", owner_dashboard_html)
        self.assertIn("This week", owner_dashboard_html)
