...
class OwnerPortalTests(unittest.TestCase):
    ...
    def test_admin_owner_login_debug_shows_persistence_snapshot(self):
        ...
        self.assertIn("Last Save Trace", html)
        self.assertIn("File exists:", html)
        self.assertIn("File size bytes:", html)
        self.assertIn("Line count:", html)
        self.assertIn("Last save path:", html)
        self.assertIn("Last save success:", html)
        self.assertIn("Last save exception:", html)
        self.assertIn("Last save account count:", html)
        self.assertIn("Last reload account count:", html)
