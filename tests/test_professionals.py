...
class ProfessionalApplicationTests(unittest.TestCase):
    ...
    def test_professionals_page_loads_with_language_buttons(self):
        ...
        self.assertIn('data-i18n="heroIntro"', html)
    ...
    def test_admin_professionals_page_loads(self):
        ...
        self.assertIn('data-i18n="adminProfessionals.heroTitle"', html)
        self.assertIn('data-i18n="adminProfessionals.statusPending"', html)
        self.assertIn('data-lang-switch="bg"', html)
        self.assertIn('data-lang-switch="en"', html)
        self.assertIn('data-lang-switch="fr"', html)
        self.assertIn('data-lang-switch="ru"', html)
    def test_admin_detail_page_loads(self):
        ...
        self.assertEqual(response.status_code, 200)
        html = response.get_data(as_text=True)
        self.assertIn('data-i18n="adminProfessionalDetail.heroTitle"', html)
        self.assertIn("Black Sea Transfers", html)
        self.assertIn("Priority candidate.", html)
        self.assertIn('data-i18n="adminProfessionalDetail.timelineTitle"', html)
        self.assertIn('data-lang-switch="bg"', html)
        self.assertIn('data-lang-switch="en"', html)
        self.assertIn('data-lang-switch="fr"', html)
        self.assertIn('data-lang-switch="ru"', html)
    ...
    def test_i18n_bootstrap_prefers_query_language_over_storage(self):
        ...
        self.assertIn('function getInitialLanguage()', text)
        self.assertIn('const fromUrl = normalizeLanguage(params.get("lang"));', text)
        self.assertIn('const fromStorage = normalizeLanguage(', text)
    ...
    def test_admin_service_requests_page_loads(self):
        ...
        self.assertEqual(response.status_code, 200)
        html = response.get_data(as_text=True)
        self.assertIn('data-i18n="metricTotal"', html)
        self.assertIn('data-i18n="metricNew"', html)
    ...
    def test_admin_service_request_detail_page_loads(self):
        ...
        self.assertIn('data-i18n="detailStatus"', html)
    ...
    def test_homepage_counters_loads(self):
        ...
        self.assertEqual(response.status_code, 200)
        html = response.get_data(as_text=True)
        self.assertIn('data-i18n="homeCountersEyebrow"', html)
        self.assertIn('data-i18n="homeCounterProvidersLabel"', html)
        self.assertIn('data-i18n="homeCounterCitiesLabel"', html)
        self.assertIn('data-i18n="homeCounterServiceRequestsLabel"', html)
    ...
    def test_network_directory_loads_and_shows_only_approved_providers(self):
        ...
        self.assertIn('data-lang-switch="en"', html)
        self.assertIn('data-lang-switch="fr"', html)
        self.assertIn('data-i18n="featuredEyebrow"', html)
        self.assertIn("Sea Breeze Cleaning", html)
        self.assertIn("Black Sea Transfers", html)
        ...
        self.assertIn('data-i18n="network.networkCategoryCleaning"', html)
        self.assertIn('data-i18n="network.networkCategoryTransfers"', html)
