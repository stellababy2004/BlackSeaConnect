(function () {
  const entries = [
    ...
    ["backToOperations", "Назад към операциите", "Back to operations", "Retour aux opérations"],
    ...
    ["operationCreateTypeLabel", "Тип операция *", "Operation type *", "Type d’opération *"],
    ...
    ["operationCreateProfessionalLabel", "Професионалист", "Professional", "Professionnel"],
    ...
    ["operationCreateErrorType", "Изберете валиден тип операция.", "Select a valid operation type.", "Sélectionnez un type d’opération valide."],
    ...
    ["operationCreateErrorProfessional", "Изберете валиден професионалист.", "Select a valid professional.", "Sélectionnez un professionnel valide."],
    ["operationCreateErrorSave", "Операцията не можа да бъде създадена.", "The operation could not be created.", "L’opération n’a pas pu être créée."],
