(function () {
  const entries = [
    ...
    ["calendarAttentionSummary", "Приоритетни оперативни сигнали, подредени по сериозност.", "Priority operational signals, sorted by severity.", "Signaux opérationnels prioritaires, classés par gravité."],
    ...
    ["calendarHealthyState", "Операциите вървят по план", "Operations are on track", "Les opérations sont sur la bonne voie"],
    ["calendarAttentionMissingProperty", "Задачи без свързан имот", "Tasks missing a property link", "Tâches sans bien associé"],
    ["calendarAttentionOverdue", "Просрочени операции", "Overdue operations", "Opérations en retard"],
    ["calendarAttentionConflicts", "Конфликти в календара", "Calendar conflicts", "Conflits de calendrier"],
    ["calendarAttentionUnassigned", "Невъзложени операции", "Unassigned operations", "Opérations non attribuées"],
    ["calendarAttentionWaitingOwner", "Операции, чакащи собственик", "Operations waiting for owner", "Opérations en attente du propriétaire"],
    ["calendarAttentionWaitingProfessional", "Операции, чакащи професионалист", "Operations waiting for a professional", "Opérations en attente d’un professionnel"],
    ...
    ["calendarManagement", "Ръководство", "Guide", "Guide"],
    ...
    ["calendarDetailSubtitleEmpty", "Изберете запис от календара, за да прегледате оперативните подробности.", "Select a calendar entry to review its operational details.", "Sélectionnez une entrée du calendrier pour consulter ses détails opérationnels."],
    ...
    ["calendarDetailStatus", "Статус", "Status", "Statut"],
    ["calendarDetailPriority", "Приоритет", "Priority", "Priorité"],
    ...
    ["calendarDetailProfessional", "Професионалист", "Professional", "Professionnel"],
    ["calendarDetailOwner", "Собственик", "Owner", "Propriétaire"],
    ["calendarDetailGuest", "Гост", "Guest", "Voyageur"],
    ["calendarDetailOperationalState", "Оперативно състояние", "Operational state", "État opérationnel"],
    ["calendarDetailLifecycle", "Текущ етап", "Current lifecycle state", "Étape actuelle"],
    ["calendarDetailSlaRisk", "SLA / риск", "SLA / risk", "SLA / risque"],
    ...
    ["calendarDetailAttachments", "Прикачени файлове", "Attachments", "Pièces jointes"],
    ...
    ["calendarDetailNoNotes", "Няма оперативна бележка.", "No operational note.", "Aucune note opérationnelle."],
    ["calendarDetailEdit", "Редактирай", "Edit", "Modifier"],
    ["calendarDetailDelete", "Изтрий", "Delete", "Supprimer"],
    ["calendarDetailOpenOperation", "Отвори операцията", "Open operation", "Ouvrir l’opération"],
    ["calendarDetailOpenProperty", "Отвори имота", "Open property", "Ouvrir le bien"],
    ["calendarDetailTimeline", "Хронология", "Timeline", "Chronologie"],
    ["calendarDetailRelatedOperations", "Свързани операции", "Related operations", "Opérations associées"],
    ["calendarDetailNoRelated", "Няма свързани критични операции.", "No related critical operations.", "Aucune opération critique associée."],
    ...
    ["calendarDetailSlaOverdue", "SLA е просрочено", "SLA overdue", "SLA en retard"],
    ["calendarDetailSlaNotTracked", "SLA не се следи", "SLA not tracked", "SLA non suivi"],
    ...
    ["calendarDetailBlockedUnassigned", "Блокирано: няма възложен професионалист", "Blocked: no professional assigned", "Bloqué : aucun professionnel attribué"],
    ["calendarQuickCreate", "Бързо създаване", "Quick create", "Création rapide"],
    ...
    ["calendarKpiActiveOperations", "Активни операции", "Active operations", "Opérations actives"],
    ...
    ["calendarKpiUnassigned", "Невъзложени", "Unassigned", "Non attribuées"],
    ...
    ["calendarKpiWaitingProfessional", "Чакат професионалист", "Waiting for professional", "En attente d’un professionnel"],
    ["calendarKpiSlaHealth", "SLA състояние", "SLA health", "Santé SLA"],
    ["calendarKpiConflicts", "Конфликти", "Calendar conflicts", "Conflits de calendrier"],
    ["calendarKpiActiveProfessionals", "Активни професионалисти", "Active professionals", "Professionnels actifs"],
    ["calendarGuideVisible", "Видими събития", "Visible events", "Événements visibles"],
    ["calendarGuideVisibleHelp", "В текущия календарен изглед", "In the current calendar view", "Dans la vue actuelle du calendrier"],
    ["calendarGuideActive", "Активни събития", "Active events", "Événements actifs"],
    ["calendarGuideActiveHelp", "Без завършени и отменени", "Excluding completed and cancelled", "Hors terminés et annulés"],
    ["calendarGuideSla", "SLA съответствие", "SLA compliance", "Conformité SLA"],
    ["calendarGuideBreaches", "нарушения", "breaches", "infractions"],
    ["calendarGuideUnassigned", "Невъзложени", "Unassigned", "Non attribués"],
    ["calendarGuideUnassignedHelp", "Оперативни събития без изпълнител", "Operational events without an assignee", "Événements opérationnels sans intervenant"],
    ["calendarGuideCompleted", "Завършени операции", "Completed operations", "Opérations terminées"],
    ["calendarGuideCompletedHelp", "В текущия филтриран период", "In the current filtered period", "Dans la période filtrée actuelle"],
    ["calendarGuideProfessionals", "Активни професионалисти", "Active professionals", "Professionnels actifs"],
    ["calendarGuideProfessionalsHelp", "Във видимите календарни събития", "In visible calendar events", "Dans les événements visibles du calendrier"],
